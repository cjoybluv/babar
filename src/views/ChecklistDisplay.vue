...
.v-carousel,
.v-carousel__item {
  min-height: calc(var(--height) - 56px) !important;
  max-height: calc(var(--height) - 56px) !important;
}
.carousel-scroll {
  min-height: calc(var(--height) - 106px) !important;
  max-height: calc(var(--height) - 106px) !important;
  overflow: scroll;
}
.v-sheet > .v-select {
  margin-top: 2px;
